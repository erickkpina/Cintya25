...
export default function MoonLetter() {
    ...
    return (
        <div
            className="fixed inset-0 z-50 bg-[#05070a] overflow-hidden flex items-center justify-center"
                        ...
                        <div className="bg-[#fdfbf7] p-8 md:p-16 shadow-2xl relative border-l-[30px] border-[#e8e4db] min-h-[500px]">
                            ...
                            <div className="relative space-y-8 font-serif text-gray-800 leading-relaxed italic">
                                ...
                                <p className="indent-8 text-lg">
                                    Se eu pudesse voar até a Lua e trazer uma
                                    estrela para você, eu o faria sem hesitar.
                                    Mas a verdade é que nenhuma estrela brilha
                                    tanto quanto o seu olhar quando você sorri
                                    para mim.
                                </p>

                                <p className="indent-8 text-lg">
                                    Nesta missão que chamamos de vida, você é
                                    meu destino e meu porto seguro. Obrigado por
                                    ser minha parceira de aventuras, por
                                    acreditar em nós e por me amar com tanta
                                    intensidade.
                                </p>

                                <p className="indent-8 text-lg">
                                    Te amo hoje, amanhã e até o fim dos tempos.
                                    Ou, como dizemos nas estrelas: até o
                                    infinito e além.
                                </p>
