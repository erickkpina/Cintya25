...
const timelineData: TimelineItem[] = [
    {
        ...
        description:
            "Aquele momento em que o universo conspirou para nossos caminhos se cruzarem pela primeira vez.",
        side: "left",
    },
    {
        id: 2,
        year: "Nossa Jornada",
        title: "As Primeiras Conversas",
        description:
            "Horas que pareciam minutos, descobrindo cada detalhe um do outro sob a luz das estrelas.",
        side: "right",
    },
    {
        id: 3,
        year: "Crescimento",
        title: "Viagens e Aventuras",
        description:
            "Cada lugar visitado tornou-se um novo capítulo na nossa constelação particular.",
        side: "left",
    },
    {
        id: 4,
        ...
        title: "Seus 25 Anos",
        description:
            "O início da sua melhor fase. Estou aqui para segurar sua mão em cada novo orbita.",
        side: "right",
    },
];
